...
cell weights. Under iterative BM25, raw replay wins under stratified,
hierarchical, and leave-one-cell-out analyses. With a frozen general dense
retriever, the point estimate favors replay by one point but hierarchical and
leave-one-cell-out analyses span both signs. The first 100 LoCoMo items all
belong to conversation 0, so conversation-level clustering is impossible for
this slice rather than silently treating it as 100 conversations. This
selector and cell dependence precludes a selector-independent deployment
conclusion.
