...
\textbf{CoMem} & one depth-$j$ residual/token & pack selected residuals & execute layers $[j{:}L)$ & explicit depth-reuse frontier \\
\bottomrule
\end{tabular}%
}
...
matched $j{=}0$ versus $j{=}12$ frontier, not superiority over these families.}
\label{tab:priorart}
\end{table*}
