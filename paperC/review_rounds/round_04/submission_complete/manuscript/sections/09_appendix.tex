...
supporting ``V2 re-sorts the 27-cell read-out''. Every value in both tables is
unchanged from the version those subsections discuss.
...
\textsf{E-I} & \texttt{tcodex\_out/EVIDENCE\_PACK.md}, Section I \\
\textsf{E-K} & \texttt{tcodex\_out/EVIDENCE\_PACK.md}, Section K; row-by-row map in \texttt{evidence/claim\_evidence\_map.tsv} \\
\textsf{E-CAL} & \texttt{evidence/floor\_winners\_curse\_calibration.json} \\
