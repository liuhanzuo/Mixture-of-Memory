...
\bottomrule
\end{tabular}
\caption{V2 re-sorts rather than uniformly deflates the read-out. All deltas are percentage points. Numbers are from \texttt{paperC/tcodex\_out/EVIDENCE\_PACK.md}, Section D.}
\label{tab:v2-resort}
\end{table*}
