...
The five smaller evidence benchmarks are unable to resolve every effect of interest, so null results are never interpreted without the power table (Table~\ref{tab:power}).
