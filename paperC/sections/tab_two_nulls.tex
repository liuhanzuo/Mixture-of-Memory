...
\bottomrule
\end{tabular}
\caption{Two nulls answer two different questions. Values and definitions are taken from the stratified permutation-null record for the re-judged cells (evidence \textsf{E-D}; see the reproducibility statement for the artifact path).}
\label{tab:two-nulls}
\end{table}
