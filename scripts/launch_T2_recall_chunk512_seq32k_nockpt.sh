...
RUN="T2_recall_chunk512_seq32k_nockpt_N128"
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29938 \
  ...
  --shared_memory_bank --gradient_accumulation_steps 2 \
