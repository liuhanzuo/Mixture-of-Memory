...
RUN="HARDOBJ_lastchunk_ctx5_seed2026_diskA"
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29916 \
  ...
  --last_chunk_loss_only --curriculum 0:5 --bptt_window 2 --no_detach_slots_in_selector \
