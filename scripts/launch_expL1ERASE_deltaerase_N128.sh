...
RUN="expL1ERASE_deltaerase_N128"
...
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29902 \
  ...
  --normalize_readout --delta_erase_write \
