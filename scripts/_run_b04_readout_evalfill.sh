...
log "NOTE: analyze_b04_wzc1_floor.py does NOT yet read these dirs -- revision 3's"
log "      GRID_I / two-grid combine is documented in DECIDABILITY_FIX_20260816.md sec 3"
log "      but NOT implemented in the analyzer (no GRID_I symbol in the code)."
log "      Computing phi is a separate, 0-GPU step."
