...
CKPT_DIR="outputs/expDENSE_N192_topkAll"
...
# Two checkpoints
CK_NAME=(expDENSE_N192_topkAll_step500 expDENSE_N192_topkAll_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expDENSE_N192_topkAll"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expDENSE_N192_topkAll_step{500,1000}"
