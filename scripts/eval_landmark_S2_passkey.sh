#!/usr/bin/env bash
# Phase-3 S2 passkey GATING — eval a trained S2 checkpoint (LLaMA-1-7B + landmark
# mechanism, trained on dolmino wiki+pes2o) with the SAME protocol as S0:
...
#
# Usage: CKPT=<path-to-ckpt-dir> CK_NAME=s2_step1000 bash scripts/eval_landmark_S2_passkey.sh
set -euo pipefail
