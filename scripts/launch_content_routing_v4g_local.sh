...
LOG_FILE=logs/content_routing_v4g_local.log

echo "=== Content Routing v4g Local (writeback_gate_max=1.0) ===" | tee $LOG_FILE
...
$PYTHON -m torch.distributed.run --nproc_per_node=8 \
    ...
    --output_dir outputs/content_routing_v4g_local \
    --total_steps 2000 \
    --lr 1e-4 \
    --warmup_steps 100 \
    --chunk_size 1024 \
    ...
    --wandb_run_name content_routing_v4g_local \
    --dtype bfloat16 \
    --attn_impl sdpa \
    --seed 42 \
    2>&1 | tee -a $LOG_FILE
