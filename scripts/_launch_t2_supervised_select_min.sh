...
RUN="mem_space_fifo_b25_c512_supervised_select_min"
mkdir -p logs
...
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PY -m torch.distributed.run --nproc_per_node=8 --master_port=29808 \
  ...
  --t2_recall_mix_fraction 0.5 --t2_background_data data/pg19_chunks_llama3.npy --t2_num_keys 1 --t2_gap_tokens 1536 --t2_background_skip 0 \
  --t2_select_loss_weight 1.0 --t2_select_layer 16 --t2_select_topk 2 \
