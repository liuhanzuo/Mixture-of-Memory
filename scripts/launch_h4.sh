...
mkdir -p outputs/experiment_h4_early_write
...
/opt/conda/envs/torch-base/bin/python3.11 /opt/conda/envs/torch-base/bin/torchrun \
  ...
  --output_dir /apdcephfs_wzc1/share_303098609/pighzliu_code/Mixture-of-Memory/outputs/experiment_h4_early_write \
  ...
  --memory_write_layer 12 --memory_read_layers 14,18,22,26 \
  --memory_init strided \
  ...
  > outputs/experiment_h4_early_write/train.log 2>&1
