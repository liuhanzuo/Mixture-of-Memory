...
CKPT_DIR="outputs/expR1c12_cum_int12"
...
# Two checkpoints
CK_NAME=(expR1c12_cum_int12_step500 expR1c12_cum_int12_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expR1c12_cum_int12"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expR1c12_cum_int12_step{500,1000}"
