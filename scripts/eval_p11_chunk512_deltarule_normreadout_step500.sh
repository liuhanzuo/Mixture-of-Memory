#!/usr/bin/env bash
# Offline BABILong eval for P11 chunk512 (delta_rule writeback + normalize_readout) ablation, step500.
...
RESULTS=babilong_results/p11_chunk512_deltarule_normreadout_step500
TASKS="qa1 qa2 qa5"
LOGDIR=logs/eval_p11_chunk512_deltarule_normreadout_step500
...
run_on_gpu() {
  ...
  for L in "$@"; do
    ...
    CUDA_VISIBLE_DEVICES=$G $PYBIN scripts/run_babilong_mem_space.py \
      ...
      --results_folder $RESULTS --output_name p11_chunk512_deltarule_normreadout_step500_${L} \
