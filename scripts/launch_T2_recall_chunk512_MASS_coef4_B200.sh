...
RUN="T2_recall_chunk512_MASS_coef4_N128"
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29966 \
  ...
  --use_readout_mass_bias --readout_mass_coef 4.0 \
