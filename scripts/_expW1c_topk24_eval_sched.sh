...
CKPT_DIR="outputs/expW1c_topk24"
...
# Two checkpoints
CK_NAME=(expW1c_topk24_step500 expW1c_topk24_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expW1c_topk24"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expW1c_topk24_step{500,1000}"
