#!/bin/bash
# Experiment F: Enhanced Retrieval Training
# Based on researcher recommendation: explicit retrieval loss + stronger curriculum
# Same slot-forward architecture as C, but:
#   - lambda_retrieve 1.0 -> 10.0 (10x stronger NIAH signal)
#   - niah_mix_fraction 0.30 -> 0.50 (more NIAH training samples)
#   - niah_warmup_steps 100 -> 200 (longer warmup for stability)
...
LOGDIR=logs
mkdir -p $LOGDIR
LOGFILE=$LOGDIR/experiment_f_retrieval_$(date +%Y%m%d_%H%M).log

echo "============================================"
echo "Experiment F: Enhanced Retrieval Training"
echo "Output: outputs/experiment_f_retrieval"
echo "Log: $LOGFILE"
echo "============================================"
...
torchrun \
    ...
    --output_dir /apdcephfs_wzc1/share_303098609/pighzliu_code/Mixture-of-Memory/outputs/experiment_f_retrieval \
