...
RUN="expR1cN256c_cum_slots256"
# L20A chunk512: physical bs4 x grad_accum1 x 8gpu = eff_batch 32 (same as P11).
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29872 \
  ...
  --chunk_size 512 --batch_size 4 --num_slots 256 --top_k 16 --selector_dim 128 \
  ...
  --wandb_run_name $RUN --dtype bfloat16 --attn_impl sdpa --seed 777" \
