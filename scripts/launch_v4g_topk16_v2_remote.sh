...
export PYTHONPATH=/apdcephfs_zwfy6/share_303098609/pighzliu_code/Mixture-of-Memory

PYTHON=/opt/conda/envs/torch-base/bin/python
rm -rf outputs/v4g_topk16_v2_remote
mkdir -p outputs/v4g_topk16_v2_remote logs
...
nohup $PYTHON -u -m torch.distributed.run --nproc_per_node=8 \
    ...
    --output_dir outputs/v4g_topk16_v2_remote \
    ...
    --wandb_run_name v4g_topk16_v2_remote \
    --dtype bfloat16 --attn_impl sdpa --seed 44 \
    > logs/v4g_topk16_v2_remote.log 2>&1 &
