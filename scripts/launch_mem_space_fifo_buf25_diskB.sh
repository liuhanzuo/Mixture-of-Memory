#!/usr/bin/env bash
# 方案B: FIFO hidden-state memory (MemoryLLM-style) — buffer25 ablation arm (short buffer)
# Runs on H20 .48.7.53 (28.48.7.53, 8× H20, 盘B share_304376610, .venv)
# Derived from launch_mem_space_fifo_b200.sh: fifo_buffer_chunks 50->25, chunk1024, rest aligned to base.
# 2026-06-24
set -euo pipefail
...
RUN="mem_space_fifo_b25_chunk1024"
mkdir -p logs
