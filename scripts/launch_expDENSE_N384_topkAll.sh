...
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29893 \
  ...
  --chunk_size 512 --batch_size 1 --num_slots 384 --top_k 384 --selector_dim 128 \
