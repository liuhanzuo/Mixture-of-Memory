#!/bin/bash
# v4f: content-based routing + TBPTT + key_repulsion_weight=0.05
...
OUTPUT_DIR=outputs/content_routing_v4f_local
LOGFILE=logs/content_routing_v4f_local.log
...
$PYTHON -m torch.distributed.run --nproc_per_node=8 \
    ...
    --wandb_run_name content_routing_v4f_local \
    --dtype bfloat16 \
    --attn_impl sdpa \
    --seed 42 \
    2>&1 | tee $LOGFILE
