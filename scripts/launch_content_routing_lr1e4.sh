#!/bin/bash
# 500-step smoke: content-based routing + TBPTT + detach fix + higher LR
# Key changes vs base: lr=1e-4, key_repulsion_weight=0.1, seed=44
set -e
...
OUTPUT_DIR=${OUTPUT_DIR_OVERRIDE:-outputs/content_routing_lr1e4}
...
$PYTHON -m torch.distributed.run --nproc_per_node=8 \
    ...
    --wandb_run_name content_routing_lr1e4_500step \
    --dtype bfloat16 \
    --attn_impl sdpa \
    --seed 44
