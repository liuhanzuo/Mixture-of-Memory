...
RUN="expDRoff_N512_deltaruleOFF"
# L20A chunk512: physical bs4 x grad_accum1 x 8gpu = eff_batch 32 (same as P11).
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29884 \
  ...
  --chunk_size 512 --batch_size 2 --num_slots 512 --top_k 16 --selector_dim 128 \
