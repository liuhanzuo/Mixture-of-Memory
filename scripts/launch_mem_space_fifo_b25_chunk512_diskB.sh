#!/usr/bin/env bash
# 方案B: FIFO hidden-state memory (MemoryLLM-style) — buffer25 chunk512 ablation arm
# Runs on H20 .48.7.53 (28.48.7.53, 8× H20 95GB, 盘B share_304376610, .venv)
# OOM fix: changed chunk_size 1024->512 from original buf25_diskB script (H20 95GB OOM with chunk1024)
...
RUN="mem_space_fifo_b25_chunk512"
mkdir -p logs
