#!/usr/bin/env bash
# Writeback-mode arm A (lowrank_gate, local H20-1): slot_dim=16384, 128 slots,
# low-rank gate (r=256) replacing the LM2 dual_gate (which would OOM at
# slot_dim=16384: two Linear(16384,32768) ≈ 34B params/layer).
# Single-variable comparison vs diag_gate (B) and scalar_beta (C).
set -euo pipefail
