#!/usr/bin/env bash
# EXP N256b (seed1234, 2nd seed) BABILong eval — dual-ckpt (step500 + step1000),
...
CKPT_DIR="outputs/expR1cN256b_cum_slots256"
...
CK_NAME=(expR1cN256b_cum_slots256_step500 expR1cN256b_cum_slots256_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expR1cN256b_cum_slots256"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expR1cN256b_cum_slots256_step{500,1000}"
