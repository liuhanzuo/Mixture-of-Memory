...
CKPT=${CKPT_DIR}/mem_space_adapter_step003000.pt
RESULTS=babilong_results/f2_longdoc_chunk512_step3000
TASKS="qa1 qa2 qa5"
LOGDIR=logs/eval_f2_longdoc_chunk512_step3000
...
run_on_gpu() {
  ...
  for L in "$@"; do
    ...
    CUDA_VISIBLE_DEVICES=$G $PYBIN scripts/run_babilong_mem_space.py \
      ...
      --results_folder $RESULTS --output_name f2_longdoc_chunk512_step3000_${L} \
