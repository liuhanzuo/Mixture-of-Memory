...
CKPT_DIR=outputs/mem_space_p11_chunk512_l3recontoken_w1.0
ADAPTER_CONFIG=${CKPT_DIR}/adapter_config.json
CKPT=${CKPT_DIR}/mem_space_adapter_step000500.pt
RESULTS=babilong_results/p11_chunk512_l3recontoken_w1.0_step500
TASKS="qa1 qa2 qa5"
LOGDIR=logs/eval_p11_chunk512_l3recontoken_w1.0_step500
...
run_on_gpu() {
  ...
  for L in "$@"; do
    ...
    CUDA_VISIBLE_DEVICES=$G $PYBIN scripts/run_babilong_mem_space.py \
      ...
      --results_folder $RESULTS --output_name p11_chunk512_l3recontoken_w1.0_step500_${L} \
