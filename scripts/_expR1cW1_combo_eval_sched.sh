#!/usr/bin/env bash
# EXP-W1c combo (sampling-recycle + top_k32) BABILong eval — dual-ckpt (step500 + step1000), LPT-balanced
...
# Two checkpoints
CK_NAME=(expR1cW1_cum_topk32_step500 expR1cW1_cum_topk32_step1000)
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expR1cW1_cum_topk32_step{500,1000}"
