#!/usr/bin/env bash
# EXP-W1c top_k24 BABILong eval — dual-ckpt (step500 + step1000), LPT-balanced
...
CKPT_DIR="outputs/expDENSE_N384_topkAll"
...
# One checkpoint (N384 training not finished; only step500 available)
CK_NAME=(expDENSE_N384_topkAll_step500)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt")

LOGDIR="logs/eval_expDENSE_N384_topkAll"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expDENSE_N384_topkAll_step{500,1000}"
