#!/usr/bin/env bash
# EXP-W1c grace3 (sampling-recycle + grace_chunks3) BABILong eval — dual-ckpt (step500 + step1000), LPT-balanced
...
#
# Runs on .249 (disk-B, share_304376610) with project .venv python.
set -uo pipefail
...
CKPT_DIR="outputs/expR1cg3_cum_grace3"
...
# Two checkpoints
CK_NAME=(expR1cg3_cum_grace3_step500 expR1cg3_cum_grace3_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expR1cg3_cum_grace3"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expR1cg3_cum_grace3_step{500,1000}"
