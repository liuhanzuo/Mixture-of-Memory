#!/usr/bin/env python3
"""
train_l3.py — 便捷的 L3 总结器 LoRA 训练入口脚本。
...
Usage::
    ...
    # 自定义参数
    python scripts/train_l3.py --epochs 5 --lr 3e-5 --lora-rank 32
"""
...
from src.training.train_l3_summarizer import L3SummarizerTrainer, L3SummarizerTrainConfig
...
def main() -> None:
    parser = argparse.ArgumentParser(description="L3 Summarizer LoRA Training")
    ...
    parser.add_argument("--save-dir", type=str, default="outputs/runs/l3_summarizer_training")
    parser.add_argument("--log-level", type=str, default="INFO")
    args = parser.parse_args()

    setup_logging(level=args.log_level)

    config = L3SummarizerTrainConfig(
        epochs=args.epochs,
