...
CKPT_DIR="outputs/expR1cN384d_cum_slots384"
...
# Two checkpoints
CK_NAME=(expR1cN384d_cum_slots384_step500 expR1cN384d_cum_slots384_step1000)
CK_FILE=("$CKPT_DIR/mem_space_adapter_step000500.pt" "$CKPT_DIR/mem_space_adapter.pt")

LOGDIR="logs/eval_expR1cN384d_cum_slots384"
mkdir -p "$LOGDIR"
...
wait
echo "[$(date)] ALL_EVAL_DONE -> babilong_results/expR1cN384d_cum_slots384_step{500,1000}"
