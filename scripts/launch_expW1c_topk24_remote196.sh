...
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29831 \
  ...
  --chunk_size 512 --batch_size 4 --num_slots 128 --top_k 24 --selector_dim 128 \
