...
export RUN_PREFIX=swaA_seed42_s1000_W0
export CKPT_FILES="outputs/mem_space_selfstudy_swateacherA_chunk512/full_model_step001000.pt"
export CK_NAMES="swaA_seed42_step1000"
