...
RUN="distill_chunk512_AB_MASS0p3_dolmino"
setsid bash -c "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 $PYBIN -m torch.distributed.run --nproc_per_node=8 --master_port=29970 \
  ...
  --use_readout_mass_bias --readout_mass_coef 0.3 \
