...
At the same nominal depth and displayed steps, ShortGPT's 15.5-point
letter-MMLU advantage but only 1.8-point content-MMLU advantage over keep14 is
not merely a warning about confounding; it identifies a productive next
experiment. The comparison couples four factors. A
...
The much smaller content-score gap further suggests that these choices
