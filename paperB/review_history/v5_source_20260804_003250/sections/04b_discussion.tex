...
\paragraph{Proxy insufficiency is narrower than ``PPL is useless.''}
Perplexity remains the direct measure of the continuation objective and is
essential for monitoring CPT. The result is instead about sufficiency: after
this structural intervention, a lower in-domain PPL does not by itself certify
performance on MMLU or the tested closed-book tasks. A compressed model may
therefore look healthier under the training-domain likelihood while still
remaining unsuitable for a target use.
