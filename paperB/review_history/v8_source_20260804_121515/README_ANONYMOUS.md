...
paired trajectory records. Local-only evaluator commits are represented by a
source snapshot plus abbreviated provenance IDs; no public commit ancestry,
historical seed, or lost loader offset is claimed.
