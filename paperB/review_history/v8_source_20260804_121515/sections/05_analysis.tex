...
Table~\ref{tab:downstream} shows that ShortGPT's advantage is not confined to
MMLU. Relative to keep14 at 200k, it gains 4.0 points on HellaSwag, 3.8 on
ARC-Challenge, 4.1 on ARC-Easy, 2.9 on WinoGrande, 4.2 on LAMBADA, and 9.1 on
BoolQ; its core6 macro rises from .5938 to .6215. The gain is therefore broad,
but highly target-dependent: the 15.5-point MMLU difference is much larger than
the 2.8-point core6 difference and the 1.8-point content-MMLU difference.
