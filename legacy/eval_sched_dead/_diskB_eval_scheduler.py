#!/usr/bin/env python
"""Ad-hoc scheduler for diskB offline BABILong eval.
8 ckpts x 7 lengths = 56 units. 8 GPUs x 2 procs = 16 slots.
...
RUNS = [
    ("f2_c1024_step500",   "outputs/f2_longdoc_chunk1024",                          "mem_space_adapter_step000500.pt", 1024),
    ("f2_c1024_step5000",  "outputs/f2_longdoc_chunk1024",                          "mem_space_adapter.pt",            1024),
    ("v3imp_s1c256_step500",  "outputs/progressive_chunk_diskB_v3_improved/stage1_c256", "mem_space_adapter_step000500.pt", 256),
    ("v3imp_s1c256_step5000", "outputs/progressive_chunk_diskB_v3_improved/stage1_c256", "mem_space_adapter.pt",            256),
    ("v3imp_s2c512_step500",  "outputs/progressive_chunk_diskB_v3_improved/stage2_c512", "mem_space_adapter_step000500.pt", 512),
    ("v3imp_s2c512_step5000", "outputs/progressive_chunk_diskB_v3_improved/stage2_c512", "mem_space_adapter.pt",            512),
    ("d6xattnoff_step500",  "outputs/d6_xattn_off",                                  "mem_space_adapter_step000500.pt", 512),
    ("d6xattnoff_step5000", "outputs/d6_xattn_off",                                  "mem_space_adapter.pt",            512),
]
...
for slot in range(SLOTS):
    if qi < len(queue):
        ...
        qi += 1
        time.sleep(2)  # stagger to avoid HF download race
