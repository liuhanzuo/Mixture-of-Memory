...
mkdir -p outputs/experiment_h5b_fixed
...
/opt/conda/envs/torch-base/bin/python3.11 /opt/conda/envs/torch-base/bin/torchrun \
  ...
  --output_dir /apdcephfs_wzc1/share_303098609/pighzliu_code/Mixture-of-Memory/outputs/experiment_h5b_fixed \
  ...
  --memory_init strided \
  --niah_mix_fraction 0.50 --niah_max_N 2 --niah_warmup_steps 100 \
  --lambda_retrieve 2.0 \
  ...
  > outputs/experiment_h5b_fixed/train.log 2>&1
