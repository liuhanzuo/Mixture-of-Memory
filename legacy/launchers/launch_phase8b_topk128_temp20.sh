#!/usr/bin/env bash
# Phase-8B: topk128 + selector_temperature=20 — combining top_k=128 with sharp routing.
#
# Rationale: topk128 alone scored 49.84, P8+temp20 scored 54.62.
# The main gap is selector_temperature (1.0 vs 20.0). With top_k=128 each chunk
# reads from 128/512=25% of slots (vs 64/512=12.5%), providing more memory coverage.
# Combined with temp20 for sharper routing, this tests whether wider top_k + sharp
# selector synergize.
#
# Target: Remote H20 (28.59.80.196, 8x H20, 97.8 GiB)
# Outputs: outputs/babilong_sft_phase8b_topk128_temp20_<timestamp>/
# Log:     logs/phase8b_topk128_temp20_<timestamp>.log
...
# Key combination: top_k=128 (from scale_topk128) + temp=20 (from P8+temp20) + chunk=1024
CHUNK_SIZE=1024
SELECTOR_TEMP=20.0
TOP_K=128
NUM_SLOTS=512
...
EXP_TAG="phase8b_topk128_temp20_${TIMESTAMP}"
...
echo "[launch] topk128 + temp20 — logging to ${LOG_FILE}"
