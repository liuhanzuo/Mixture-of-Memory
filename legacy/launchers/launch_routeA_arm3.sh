#!/usr/bin/env bash
# ROUTE-A balance sweep arm3: identical to launch_mem_space_p11_chunk512_remote196.sh
# EXCEPT --selector_temperature 40 -> 20 (+ total_steps 1000 for the sweep).
# Goal: lift usage_cov (~0.25, only ~32/128 slots used) via softer routing temperature.
set -euo pipefail
