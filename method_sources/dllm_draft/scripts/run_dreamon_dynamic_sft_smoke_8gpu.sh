...
PORT="${MASTER_PORT:-29622}"
OUT="${DREAMON_DYNAMIC_SMOKE_OUT:-$ROOT/outputs/dreamon_dynamic_sft_smoke}"
...
test -s "$METRICS"
date --iso-8601=seconds >"$ROOT/ops/control/dreamon_dynamic_sft_smoke.done"
