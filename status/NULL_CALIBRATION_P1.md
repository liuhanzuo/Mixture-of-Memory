...
in `paperD_research/align_cka/` (109 JSON files, 1.7 MB, copied `scp -O` from
`.73:/apdcephfs_zwfy6/.../paperD_research/align_cka/`). No activations were
...
2. **longest-option floor .2822 → .2845.** The `.2822` recorded in
   `paperE_research/MAIN_verified_interface_validity.md:137` is the
