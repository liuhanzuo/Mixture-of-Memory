...
| 节点 | 任务 | 实测 | 状态 |
|---|---|---|---|
| **LOCAL** | SparseForge **noslorb** | iter **7095/7500** (94.6%)、剩 405、**last-60 47.00 s/it**、ETA **5.9 h** | ▶️ 健康 |
| **`.212`** | SparseForge **slorb** | iter **6884/7500** (91.8%)、剩 616、**last-60 47.98 s/it**、ETA **9.1 h** | ▶️ 健康 |
